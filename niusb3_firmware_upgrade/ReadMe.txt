========================================================================
    APPLICAZIONE CONSOLE: cenni preliminari sul progetto niusb3_firmware_upgrade
========================================================================

La creazione guidata applicazione ha creato questa applicazione niusb3_firmware_upgrade.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione niusb3_firmware_upgrade.


niusb3_firmware_upgrade.vcxproj
...
niusb3_firmware_upgrade.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato niusb3_firmware_upgrade.pch e il file dei tipi precompilato StdAfx.obj.
